        ...
        <div className="row " style={{ marginTop: "135px" }}>
          ...
          <div className="col-md-6 ">
            <img
              src={image1}
              alt=".."
              style={{ width: "80%", height: "85%", marginLeft: "95px" }}
            />
          </div>
        </div>
        ...
        <div className="row" style={{ marginTop: "135px" }}>
          ...
          <div className="col-md-6 mt-4">
            <div className="ms-4">
              ...
              <div style={{ marginTop: "80px", fontSize: "18px" }}>
                <p>
                  Download Booksy, a free online appointment booking app, and
                  manage your appointments from anywhere. Reschedule or cancel
                  without picking up the phone.And because we know life gets
                  busy, we'll send you reminders. You'll never forget or miss
        ...
        <div className="row " style={{ marginTop: "135px" }}>
          ...
          <div className="col-md-6 ">
            <img
              src={image3}
              alt="..."
              style={{ width: "90%", height: "90%", marginLeft: "95px" }}
            />
          </div>
        </div>
      </div>
