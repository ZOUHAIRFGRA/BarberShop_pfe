      ...
      <section className="about-2 pt-5  ">
        ...
        <div className="container py-5 w-75">
          ...
          <p>
            ...
            result, many barbers offer classic and retro-style haircuts. Barbers
            can also shave, shampoo, and color their client's hair and beards.
            Barbers are also known for their customer service skills and
            personability. If your beard is getting out of control (or you want
            a professional to shave the hair off the back of your neck,
            <strong> a visit to a barber is perfect!</strong>
          </p>
        </div>
        <div className="container py-3 w-75">
          <h1 className="text-center pb-5 ">How to Find the Best Barber?</h1>
          <p>
            At GoMyBarber, we make finding the perfect barbershop a total
            breeze. You can instantly view all the barbershops that are close to
            your home. You can check out their prices, services offered, and
            more, When looking for a barber, you should consider a few things.
            Take into consideration your price range, the location, reviews, and
